import 'package:dhanda_app/NavBar/homePageNavBar.dart';
import 'package:dhanda_app/core/constants/image_constants.dart';
import 'package:dhanda_app/features/home/widgets/sect_home_2bt.dart';
import 'package:dhanda_app/features/home/widgets/section_divider.dart';
...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      drawer: HomeNavBar(
        name: "No-Name Traders",
        gstin: "29ASJKNF945SJKD30",
        date: "January, 2022",
      ),
      ...
      appBar: AppBar(
        ...
        leading: Builder(builder: (context) {
          return IconButton(
            ...
            onPressed: () {
              // Call openDrawer() on the GlobalKey of the Scaffold
